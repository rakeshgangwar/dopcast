"""
Enhanced LangGraph implementation for the Script Generation Agent.
...
from .enhanced_script_nodes import (
...
def create_enhanced_script_graph() -> StateGraph:
    """
    Create the enhanced script generation workflow graph.
    ...
    logger.info("Added nodes to the enhanced script generation graph builder")
    ...
    graph_builder.add_edge("prepare_content_outline", "prepare_research_data")
    graph_builder.add_edge("prepare_research_data", "prepare_host_personalities")
    ...
    logger.info("Defined edges in the enhanced script generation graph")
    
    # Compile the graph
    graph = graph_builder.compile()
    logger.info("Compiled the enhanced script generation LangGraph")
